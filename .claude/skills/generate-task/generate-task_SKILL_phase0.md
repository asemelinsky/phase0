...
```json
"drawing_guide": [
  [[50,50],[50,250],[150,250],[150,150],[250,150]],   // штрих 1 (напр. літера К)
  [[300,50],[500,50],[500,350],[300,350],[300,50]],   // штрих 2 (напр. літера О)
  [[600,50],[750,50],[750,250],[650,250],[650,350]]   // штрих 3 (напр. літера Д)
]
```

**Правила:**
- Координати — ті самі що у `startX/Y`, `target_x/Y` (кратні 50px)
- Штрихи виводяться блідо-фіолетовими лініями під pencil trail
- Генеруй з solution: простежи позицію героя по блоках і запиши waypoints для кожного pen-down сегменту
