...
Дитина намагалась але щось пішло не так. М'яко підбадьор і дай натяк. Не кажи відповідь прямо.`;
        ...
        case 'question':
            return `Поточне завдання: "${name}". ${desc}
Дитина запитала голосом: "${task?.question || 'щось цікаве'}".
Якщо питання про завдання або "що робити" — поясни конкретно і зрозуміло для дитини 6–9 років, 1–3 речення.
Якщо питання загальне (не про завдання) — дай коротку цікаву відповідь з гумором.
Говори просто, тепло, без зайвих слів.`;
